...
internal class InsforgeChannelImpl(
    ...
    private var insertListener: Realtime.EventCallback<dev.insforge.realtime.models.SocketMessage>? = null
    private var updateListener: Realtime.EventCallback<dev.insforge.realtime.models.SocketMessage>? = null
    private var deleteListener: Realtime.EventCallback<dev.insforge.realtime.models.SocketMessage>? = null
    ...
    private fun setupEventListeners() {
        ...
        updateListener = Realtime.EventCallback<dev.insforge.realtime.models.SocketMessage> { message ->
            message?.let { handleSocketMessage("UPDATE", it) }
        }
        realtime.on("UPDATE", updateListener!!)

        // Listen for DELETE events
        deleteListener = Realtime.EventCallback<dev.insforge.realtime.models.SocketMessage> { message ->
     ...
     */
    private fun handleSocketMessage(eventType: String, message: dev.insforge.realtime.models.SocketMessage) {
